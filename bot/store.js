		...
		return new Promise(function (resolve) {
			...
			let vouchers = _.forEach(loadedVouchers)
				.map(function (loadedVoucher) {
					return new Voucher(loadedVoucher.id, loadedVoucher.title, loadedVoucher.emailTitle, loadedVoucher.store, loadedVoucher.description, loadedVoucher.imageUrl, loadedVoucher.points, loadedVoucher.cta);
				});
